...
/*   Updated: 2022/03/27 10:05:39 by igomez-p         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
Contact::setContact(int index, Contact::Contact pers)
{
    this.index = index;
...
Contact::setName(std::string first, std::string last)
{
    this.first_name = first;
    this.last_name = last;
}

Contact::setNickname(std::string nick) { this.nickname = nick; }
Contact::setPhone(std::string phone) { this.phone = phone; }
Contact::setSecret(std::string secret) { this.darkest_secret = secret; }